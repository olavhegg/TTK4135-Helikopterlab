  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% helicopter_day4_P.HILInitialize_OOTerminate
	  section.data(1).logicalSrcIdx = 11;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_day4_P.HILInitialize_OOExit
	  section.data(2).logicalSrcIdx = 12;
	  section.data(2).dtTransOffset = 1;
	
	  ;% helicopter_day4_P.HILInitialize_OOStart
	  section.data(3).logicalSrcIdx = 13;
	  section.data(3).dtTransOffset = 2;
	
	  ;% helicopter_day4_P.HILInitialize_OOEnter
	  section.data(4).logicalSrcIdx = 14;
	  section.data(4).dtTransOffset = 3;
	
	  ;% helicopter_day4_P.HILInitialize_AOFinal
	  section.data(5).logicalSrcIdx = 15;
	  section.data(5).dtTransOffset = 4;
	
	  ;% helicopter_day4_P.HILInitialize_POFinal
	  section.data(6).logicalSrcIdx = 16;
	  section.data(6).dtTransOffset = 5;
	
	  ;% helicopter_day4_P.HILInitialize_AIHigh
	  section.data(7).logicalSrcIdx = 17;
	  section.data(7).dtTransOffset = 6;
	
	  ;% helicopter_day4_P.HILInitialize_AILow
	  section.data(8).logicalSrcIdx = 18;
	  section.data(8).dtTransOffset = 7;
	
	  ;% helicopter_day4_P.HILInitialize_AOHigh
	  section.data(9).logicalSrcIdx = 19;
	  section.data(9).dtTransOffset = 8;
	
	  ;% helicopter_day4_P.HILInitialize_AOLow
	  section.data(10).logicalSrcIdx = 20;
	  section.data(10).dtTransOffset = 9;
	
	  ;% helicopter_day4_P.HILInitialize_AOInitial
	  section.data(11).logicalSrcIdx = 21;
	  section.data(11).dtTransOffset = 10;
	
	  ;% helicopter_day4_P.HILInitialize_AOWatchdog
	  ...
	  ;% helicopter_day4_P.HILInitialize_POLeading
	  section.data(14).logicalSrcIdx = 24;
	  section.data(14).dtTransOffset = 13;
	
	  ;% helicopter_day4_P.HILInitialize_POTrailing
	  section.data(15).logicalSrcIdx = 25;
	  section.data(15).dtTransOffset = 14;
	
	  ;% helicopter_day4_P.HILInitialize_POInitial
	  section.data(16).logicalSrcIdx = 26;
	  section.data(16).dtTransOffset = 15;
	
	  ;% helicopter_day4_P.HILInitialize_POWatchdog
	  ...
	  ;% helicopter_day4_P.HILInitialize_CKChannels
	  section.data(1).logicalSrcIdx = 59;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_day4_P.HILInitialize_DOWatchdog
	  section.data(2).logicalSrcIdx = 60;
	  section.data(2).dtTransOffset = 3;
	
	  ;% helicopter_day4_P.HILInitialize_EIInitial
	  section.data(3).logicalSrcIdx = 61;
	  section.data(3).dtTransOffset = 4;
	
	  ;% helicopter_day4_P.HILInitialize_POModes
	  section.data(4).logicalSrcIdx = 62;
	  section.data(4).dtTransOffset = 5;
	
	  ;% helicopter_day4_P.HILInitialize_POConfiguration
	  section.data(5).logicalSrcIdx = 63;
	  section.data(5).dtTransOffset = 6;
	
	  ;% helicopter_day4_P.HILInitialize_POAlignment
	  section.data(6).logicalSrcIdx = 64;
	  section.data(6).dtTransOffset = 7;
	
	  ;% helicopter_day4_P.HILInitialize_POPolarity
	  ...
	  ;% helicopter_day4_P.HILInitialize_AIChannels
	  ...
	  ;% helicopter_day4_P.HILInitialize_EIChannels
	  section.data(3).logicalSrcIdx = 69;
	  section.data(3).dtTransOffset = 16;
	
	  ;% helicopter_day4_P.HILInitialize_EIQuadrature
	  ...
	  ;% helicopter_day4_P.HILInitialize_AOTerminate
	  section.data(2).logicalSrcIdx = 75;
	  section.data(2).dtTransOffset = 1;
	
	  ;% helicopter_day4_P.HILInitialize_AOExit
	  section.data(3).logicalSrcIdx = 76;
	  section.data(3).dtTransOffset = 2;
	
	  ;% helicopter_day4_P.HILInitialize_DOTerminate
	  section.data(4).logicalSrcIdx = 77;
	  section.data(4).dtTransOffset = 3;
	
	  ;% helicopter_day4_P.HILInitialize_DOExit
	  section.data(5).logicalSrcIdx = 78;
	  section.data(5).dtTransOffset = 4;
	
	  ;% helicopter_day4_P.HILInitialize_POTerminate
	  section.data(6).logicalSrcIdx = 79;
	  section.data(6).dtTransOffset = 5;
	
	  ;% helicopter_day4_P.HILInitialize_POExit
	  section.data(7).logicalSrcIdx = 80;
	  section.data(7).dtTransOffset = 6;
	
	  ;% helicopter_day4_P.HILInitialize_CKPStart
	  section.data(8).logicalSrcIdx = 81;
	  section.data(8).dtTransOffset = 7;
	
	  ;% helicopter_day4_P.HILInitialize_CKPEnter
	  section.data(9).logicalSrcIdx = 82;
	  section.data(9).dtTransOffset = 8;
	
	  ;% helicopter_day4_P.HILInitialize_CKStart
	  section.data(10).logicalSrcIdx = 83;
	  section.data(10).dtTransOffset = 9;
	
	  ;% helicopter_day4_P.HILInitialize_CKEnter
	  section.data(11).logicalSrcIdx = 84;
	  section.data(11).dtTransOffset = 10;
	
	  ;% helicopter_day4_P.HILInitialize_AIPStart
	  section.data(12).logicalSrcIdx = 85;
	  section.data(12).dtTransOffset = 11;
	
	  ;% helicopter_day4_P.HILInitialize_AIPEnter
	  section.data(13).logicalSrcIdx = 86;
	  section.data(13).dtTransOffset = 12;
	
	  ;% helicopter_day4_P.HILInitialize_AOPStart
	  section.data(14).logicalSrcIdx = 87;
	  section.data(14).dtTransOffset = 13;
	
	  ;% helicopter_day4_P.HILInitialize_AOPEnter
	  section.data(15).logicalSrcIdx = 88;
	  section.data(15).dtTransOffset = 14;
	
	  ;% helicopter_day4_P.HILInitialize_AOStart
	  section.data(16).logicalSrcIdx = 89;
	  section.data(16).dtTransOffset = 15;
	
	  ;% helicopter_day4_P.HILInitialize_AOEnter
	  section.data(17).logicalSrcIdx = 90;
	  section.data(17).dtTransOffset = 16;
	
	  ;% helicopter_day4_P.HILInitialize_AOReset
	  section.data(18).logicalSrcIdx = 91;
	  section.data(18).dtTransOffset = 17;
	
	  ;% helicopter_day4_P.HILInitialize_DOPStart
	  section.data(19).logicalSrcIdx = 92;
	  section.data(19).dtTransOffset = 18;
	
	  ;% helicopter_day4_P.HILInitialize_DOPEnter
	  section.data(20).logicalSrcIdx = 93;
	  section.data(20).dtTransOffset = 19;
	
	  ;% helicopter_day4_P.HILInitialize_DOStart
	  section.data(21).logicalSrcIdx = 94;
	  section.data(21).dtTransOffset = 20;
	
	  ;% helicopter_day4_P.HILInitialize_DOEnter
	  section.data(22).logicalSrcIdx = 95;
	  section.data(22).dtTransOffset = 21;
	
	  ;% helicopter_day4_P.HILInitialize_DOReset
	  section.data(23).logicalSrcIdx = 96;
	  section.data(23).dtTransOffset = 22;
	
	  ;% helicopter_day4_P.HILInitialize_EIPStart
	  section.data(24).logicalSrcIdx = 97;
	  section.data(24).dtTransOffset = 23;
	
	  ;% helicopter_day4_P.HILInitialize_EIPEnter
	  section.data(25).logicalSrcIdx = 98;
	  section.data(25).dtTransOffset = 24;
	
	  ;% helicopter_day4_P.HILInitialize_EIStart
	  section.data(26).logicalSrcIdx = 99;
	  section.data(26).dtTransOffset = 25;
	
	  ;% helicopter_day4_P.HILInitialize_EIEnter
	  section.data(27).logicalSrcIdx = 100;
	  section.data(27).dtTransOffset = 26;
	
	  ;% helicopter_day4_P.HILInitialize_POPStart
	  section.data(28).logicalSrcIdx = 101;
	  section.data(28).dtTransOffset = 27;
	
	  ;% helicopter_day4_P.HILInitialize_POPEnter
	  section.data(29).logicalSrcIdx = 102;
	  section.data(29).dtTransOffset = 28;
	
	  ;% helicopter_day4_P.HILInitialize_POStart
	  section.data(30).logicalSrcIdx = 103;
	  section.data(30).dtTransOffset = 29;
	
	  ;% helicopter_day4_P.HILInitialize_POEnter
	  section.data(31).logicalSrcIdx = 104;
	  section.data(31).dtTransOffset = 30;
	
	  ;% helicopter_day4_P.HILInitialize_POReset
	  section.data(32).logicalSrcIdx = 105;
	  section.data(32).dtTransOffset = 31;
	
	  ;% helicopter_day4_P.HILInitialize_OOReset
	  section.data(33).logicalSrcIdx = 106;
	  section.data(33).dtTransOffset = 32;
	
	  ;% helicopter_day4_P.HILInitialize_DOFinal
	  section.data(34).logicalSrcIdx = 107;
	  section.data(34).dtTransOffset = 33;
	
	  ;% helicopter_day4_P.HILInitialize_DOInitial
	  ...
	  ;% helicopter_day4_P.HILReadEncoderTimebase_Overflow
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% helicopter_day4_B.FromWorkspace
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_day4_B.FromWorkspace2
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 1;
	
	  ;% helicopter_day4_B.FromWorkspace1
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 2;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% helicopter_day4_DW.FromWorkspace_IWORK.PrevIndex
	  ...
	  ;% helicopter_day4_DW.If_ActiveSubsystem
  ...
  targMap.checksum0 = 3577564809;
  targMap.checksum1 = 3672591576;
  targMap.checksum2 = 337917645;
  targMap.checksum3 = 801358268;
