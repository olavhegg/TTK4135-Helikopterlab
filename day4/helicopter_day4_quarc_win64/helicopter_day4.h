 ...
 * '<S6>'   : 'helicopter_day4/Elevation controller/If Action Subsystem'
 * '<S7>'   : 'helicopter_day4/Helicopter_interface/Elevation rad to deg'
 * '<S8>'   : 'helicopter_day4/Helicopter_interface/Elevation rate rad to deg'
 * '<S9>'   : 'helicopter_day4/Helicopter_interface/Pitch rad to deg'
 * '<S10>'  : 'helicopter_day4/Helicopter_interface/Pitch rate rad to deg'
 * '<S11>'  : 'helicopter_day4/Helicopter_interface/Pitch rate rad to deg1'
 * '<S12>'  : 'helicopter_day4/Helicopter_interface/Travel rad to deg'
 * '<S13>'  : 'helicopter_day4/Helicopter_interface/Travel rate  rad to deg'
 */
