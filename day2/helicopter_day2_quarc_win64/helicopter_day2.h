...
#ifndef RTW_HEADER_helicopter_day2_h_
#define RTW_HEADER_helicopter_day2_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef helicopter_day2_COMMON_INCLUDES_
#define helicopter_day2_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* helicopter_day2_COMMON_INCLUDES_ */

#include "helicopter_day2_types.h"
...
#define helicopter_day2_rtModel        RT_MODEL_helicopter_day2_T
...
#define rtB                            helicopter_day2_B
#define BlockIO                        B_helicopter_day2_T
#define rtX                            helicopter_day2_X
#define ContinuousStates               X_helicopter_day2_T
#define rtXdot                         helicopter_day2_XDot
#define StateDerivatives               XDot_helicopter_day2_T
#define tXdis                          helicopter_day2_XDis
#define StateDisabled                  XDis_helicopter_day2_T
#define rtP                            helicopter_day2_P
#define Parameters                     P_helicopter_day2_T
#define rtDWork                        helicopter_day2_DW
#define D_Work                         DW_helicopter_day2_T

/* Parameters (default storage) */
struct P_helicopter_day2_T_ {
...
struct tag_RTM_helicopter_day2_T {
  const char_T *path;
...
extern P_helicopter_day2_T helicopter_day2_P;

/* Block signals (default storage) */
extern B_helicopter_day2_T helicopter_day2_B;

/* Continuous states (default storage) */
extern X_helicopter_day2_T helicopter_day2_X;

/* Block states (default storage) */
extern DW_helicopter_day2_T helicopter_day2_DW;

/* Model entry point functions */
extern void helicopter_day2_initialize(void);
extern void helicopter_day2_output(void);
extern void helicopter_day2_update(void);
extern void helicopter_day2_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern helicopter_day2_rtModel *helicopter_day2(void);
...
extern RT_MODEL_helicopter_day2_T *const helicopter_day2_M;
 ...
 *
 * '<Root>' : 'helicopter_day2'
 * '<S1>'   : 'helicopter_day2/Conversion'
 * '<S2>'   : 'helicopter_day2/Degrees to Radians'
 * '<S3>'   : 'helicopter_day2/Elevation controller'
 * '<S4>'   : 'helicopter_day2/Helicopter_interface'
 * '<S5>'   : 'helicopter_day2/Pitch controller'
 * '<S6>'   : 'helicopter_day2/Elevation controller/If Action Subsystem'
 * '<S7>'   : 'helicopter_day2/Helicopter_interface/Elevation rad to deg'
 * '<S8>'   : 'helicopter_day2/Helicopter_interface/Elevation rate rad to deg'
 * '<S9>'   : 'helicopter_day2/Helicopter_interface/Pitch rad to deg'
 * '<S10>'  : 'helicopter_day2/Helicopter_interface/Pitch rate rad to deg'
 * '<S11>'  : 'helicopter_day2/Helicopter_interface/Pitch rate rad to deg1'
 * '<S12>'  : 'helicopter_day2/Helicopter_interface/Travel rad to deg'
 * '<S13>'  : 'helicopter_day2/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter_day2_h_ */
